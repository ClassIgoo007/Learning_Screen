...
class BlankScreen extends StatefulWidget {
  const BlankScreen({super.key, required this.openAI});
...
class _BlankScreenState extends State<BlankScreen> {
  ...
  void initState() {
    super.initState();
    _items = List<ClozeSentence>.from(kCloudLesson.clozeSentences);
    _initFields();
  }
            ...
            children: [
              ContentFrame(
                child: Column(
                  ...
                  children: [
                    PassageCard(passage: kCloudLesson.passageTwo),
