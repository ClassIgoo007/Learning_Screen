...
/// Holds the four screens. Each keeps its own answers while the student moves
/// between them, and those off screen have their tickers muted so nothing
/// animates unseen.
...
class _LessonShellState extends State<LessonShell> {
  ...
  static const _subtitles = <String>[
    'Figs. 4-8 and 4-9 · The figures, animated',
    'Part 1 · Multiple choice',
    'Part 2 · Fill in',
    'Tables 4-2 and 4-3 · Reference',
  ];
        ...
        body: SafeArea(
          child: IndexedStack(
            ...
            children: [
              ...
              _page(const ChoiceScreen(lesson: kCryogenicsLesson), _tab == 1),
              _page(const BlankScreen(lesson: kCryogenicsLesson), _tab == 2),
              _page(const TableScreen(), _tab == 3),
            ],
          ),
        ),
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const [
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.ac_unit, color: Palette.slate),
              label: 'Animation',
            ),
            NavigationDestination(
            ...
            NavigationDestination(
              ...
              selectedIcon: Icon(Icons.table_chart, color: Palette.slate),
              label: 'Tables',
            ),
          ],
        ),
