        ...
        child: ContentWidth(
          child: ListView(
            ...
            children: [
              ...
              const Text(
                'A leaf takes in carbon dioxide from the air while the roots '
                'pull up water and minerals. Inside the chloroplasts, light '
                'energy runs the reactions that build sugar and release '
                'oxygen. Choose an activity to practise what you know.',
