...
const String kDiagramAsset = 'assets/photosynthesis_diagram.jpg';

/// The photosynthesis diagram, shown as a tappable card.
...
class DiagramCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Semantics(
          label: 'Photosynthesis diagram. Double tap to open and zoom.',
          image: true,
          child: Material(
            color: Colors.white,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Photosynthesis diagram'),
      ),
      body: Center(
      ...
      child: Column(
        ...
        children: [
          InkWell(
            ...
            child: Row(
              children: [
                const Icon(Icons.image_outlined, size: 18, color: kGreenDark),
                const SizedBox(width: 8),
                const Expanded(
                  child: Text('Photosynthesis diagram',
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: kGreenDark)),
                ),
                Text(_open ? 'Hide' : 'Show',
                    style: const TextStyle(
                        color: kGreenDark, fontWeight: FontWeight.w600)),
