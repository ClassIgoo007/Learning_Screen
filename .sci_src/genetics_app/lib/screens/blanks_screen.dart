  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Reading & Fill in the Blanks'),
        actions: [
          IconButton(
            tooltip: 'Start over',
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, _) => ContentWidth(
          child: ListView(
            ...
            children: [
              const PassageCard(passage: kPassageTwo),
              const SizedBox(height: 16),
              const Text(
                'Complete each sentence with a word from the passage above. '
                'Spelling counts, but capital letters do not — and numbers '
                'may be written as digits or words.',
...
class _BlankCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (showRight) borderColor = kTeal;
                  ...
                  child: Text.rich(
                    TextSpan(children: [
                      ...
                      const TextSpan(
                        text: '_______',
                        style: TextStyle(
                            color: kTealDark, fontWeight: FontWeight.bold),
                      ),
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: checked && filled
                    ? Icon(
                        ...
                        color: correct ? kTealDark : Colors.red.shade600,
                      )
                    : null,
